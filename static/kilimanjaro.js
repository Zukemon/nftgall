...
function init() {
  ...
  camera.position.set(-0.5, 0.1, 2.7);
  ...
  new RGBELoader()
    ...
    .load('night.hdr', function(texture) {
      ...
      loader.load('kilimanjaro.glb', function(gltf) {
        ...
        var action_d = mixer.clipAction( gltf.animations[ 3 ]);
        var action_e = mixer.clipAction( gltf.animations[ 4 ]);
        var action_f = mixer.clipAction( gltf.animations[ 5 ]);
        var action_g = mixer.clipAction( gltf.animations[ 6 ]);
        var action_h = mixer.clipAction( gltf.animations[ 7 ]);
...
var audio = new Audio('static/music/kilimanjaro.mp3');
audio.volume = 0.05;
