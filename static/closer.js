...
function init() {
  ...
  camera.position.set(-1.8, 0.9, 7.7);
  ...
  new RGBELoader()
    ...
    .load('yello4.hdr', function(texture) {
      ...
      loader.load('closer.glb', function(gltf) {
...
function onClick() {
  ...
  if (intersects.length > 0) {
    ...
    if (audio.paused) {
      ...
      // if (!isPlay) return;
      // $(".popup").append("<div class= 'text'> <p>Play</p> </div>")
    } else  {
      audio.pause();
      
      // demo.innerHTML = "Pause";
      // ppbutton.innerHTML = "Pause";
      mixer.pauseAllAction();
      // $(".popup").append("<div class= 'text'> <p>Play</p> </div>")
    }
...
var audio = new Audio('static/music/come_closer.mp3');
audio.volume = 0.05;
